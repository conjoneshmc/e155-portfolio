...
description: "When you're just a couple pins short"
author: "Connor Jones"
date: "2026-09-11"
draft: false
---
...
![Simulation waveforms for the top-level multiplexed 7-segment display module.](media/sim-display.png)
...
![](media/sim-keypad-1.png)

![Simulation waveforms for the top-level keypad scanner module.](media/sim-keypad-2.png)
...
![](media/sim-scanner-1.png)

![](media/sim-scanner-2.png)

![Simulation waveforms for the scanner module.](media/sim-scanner-3.png)
...
- **Documentation and calculations:** ~5 hours
- **Lab writeup:** ~3 hours
...
- Once again, I would shorten the `always_comb` block multiplexing between the two input digits to a single `assign` statement with a ternary operator.
- The code correctly interfaces with the provided `seg7` module.
- The code synthesizes successfully.